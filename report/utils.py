...
class AppointmentReport:
    ...
    def appointment_summary(self):
        ...
        return {
            ...
            'cancelled_cost': self.get_cancelled_appointments_earning(),
            'no_show': self.get_count_on_status('not_visited'),
            'no_show_cost': self.get_cost_on_status('not_visited'),
    ...
    def revenue_summary(self):
        return {
            ...
            'chiropracti_session_1_12':
                self.get_procedure_appointments_earning('Chiropractic '
                                                        'Treatment Plan > '
                                                        'Session 1/12'),
    ...
    def income_summary(self):
        ...
        return {
            ...
            'income_after_discount': price_format(cost - discount),
